...
import fs from 'fs';
const html = fs.readFileSync('octubre.html','utf8');
...
await p.pdf({
  path:'Endulcora-octubre-2026.pdf',
  format:'A4', printBackground:true,
  margin:{top:'14mm',bottom:'16mm',left:'12mm',right:'12mm'},
  displayHeaderFooter:true,
  headerTemplate:'<div></div>',
  footerTemplate:'<div style="width:100%;font-family:Helvetica,Arial,sans-serif;font-size:7.5pt;color:#7A6579;padding:0 12mm;display:flex;justify-content:space-between;"><span>Endulcora · Propuesta de calendario · octubre 2026</span><span class="pageNumber"></span>/<span class="totalPages"></span></div>'
});
